...
void protobuf_AssignDesc_EnterRoom_2eproto() {
  protobuf_AddDesc_EnterRoom_2eproto();
  const ::google::protobuf::FileDescriptor* file =
    ::google::protobuf::DescriptorPool::generated_pool()->FindFileByName(
      "EnterRoom.proto");
  GOOGLE_CHECK(file != NULL);
  EnterRoom_descriptor_ = file->message_type(0);
  static const int EnterRoom_offsets_[1] = {
    GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(EnterRoom, room_key_),
  };
...
inline void protobuf_AssignDescriptorsOnce() {
  ::google::protobuf::GoogleOnceInit(&protobuf_AssignDescriptors_once_,
                 &protobuf_AssignDesc_EnterRoom_2eproto);
}
...
void protobuf_AddDesc_EnterRoom_2eproto() {
  ...
  ::google::protobuf::DescriptorPool::InternalAddGeneratedFile(
    "\n\017EnterRoom.proto\"\035\n\tEnterRoom\022\020\n\010room_k"
    "ey\030\001 \001(\t", 48);
  ::google::protobuf::MessageFactory::InternalRegisterGeneratedFile(
    "EnterRoom.proto", &protobuf_RegisterTypes);
  EnterRoom::default_instance_ = new EnterRoom();
  EnterRoom::default_instance_->InitAsDefaultInstance();
  ::google::protobuf::internal::OnShutdown(&protobuf_ShutdownFile_EnterRoom_2eproto);
}

// Force AddDescriptors() to be called at static initialization time.
struct StaticDescriptorInitializer_EnterRoom_2eproto {
  StaticDescriptorInitializer_EnterRoom_2eproto() {
    protobuf_AddDesc_EnterRoom_2eproto();
  }
} static_descriptor_initializer_EnterRoom_2eproto_;

// ===================================================================

#ifndef _MSC_VER
const int EnterRoom::kRoomKeyFieldNumber;
#endif  // !_MSC_VER
...
const EnterRoom& EnterRoom::default_instance() {
  if (default_instance_ == NULL) protobuf_AddDesc_EnterRoom_2eproto();
